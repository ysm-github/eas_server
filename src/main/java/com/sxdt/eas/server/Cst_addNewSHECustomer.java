...
//2.1	客户新增
public class Cst_addNewSHECustomer extends HttpServlet {
	...
	private String cmd="/crm/customer/addNewSHECustomer.do";
	...
	public void init() throws ServletException {
		...
		content.put("cstGUID", UUID.randomUUID().toString().toUpperCase());
		content.put("eventGUID", UUID.randomUUID().toString().toUpperCase());
